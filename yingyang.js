...
var ASM_CONSTS = {
  87232: () => { if (document.fullscreenElement) return 1; },  
 87278: () => { return document.getElementById('canvas').width; },  
 87330: () => { return parseInt(document.getElementById('canvas').style.width); },  
 87398: () => { document.exitFullscreen(); },  
 87425: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 87498: () => { if (document.fullscreenElement) return 1; },  
 87544: () => { return document.getElementById('canvas').width; },  
 87596: () => { return screen.width; },  
 87621: () => { document.exitFullscreen(); },  
 87648: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 87781: () => { if (document.fullscreenElement) return 1; },  
 87827: () => { return document.getElementById('canvas').width; },  
 87879: () => { return parseInt(document.getElementById('canvas').style.width); },  
 87947: () => { if (document.fullscreenElement) return 1; },  
 87993: () => { return document.getElementById('canvas').width; },  
 88045: () => { return screen.width; },  
 88070: () => { if (document.fullscreenElement) return 1; },  
 88116: () => { return document.getElementById('canvas').width; },  
 88168: () => { return screen.width; },  
 88193: () => { document.exitFullscreen(); },  
 88220: () => { if (document.fullscreenElement) return 1; },  
 88266: () => { return document.getElementById('canvas').width; },  
 88318: () => { return parseInt(document.getElementById('canvas').style.width); },  
 88386: () => { document.exitFullscreen(); },  
 88413: () => { return screen.width; },  
 88438: () => { return screen.height; },  
 88464: () => { return window.screenX; },  
 88491: () => { return window.screenY; },  
 88518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 88571: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 88642: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 88699: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 88770: () => { if (document.fullscreenElement) return 1; },  
 88816: () => { if (document.pointerLockElement) return 1; }
};
